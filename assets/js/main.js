...
function addEmployee(event) {
  ...
  var $imputName = document.querySelector('input[name = "name"]');
  var $imputAge = document.querySelector('input[name = "age"]');
  var $imputSalary = document.querySelector('input[name = "salary"]');

  var employee = {
    name: $imputName.value,
    age: $imputAge.value,
    salary: $imputSalary.value,
  };
